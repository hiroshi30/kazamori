...
ActivationFunction Sigmoid = {Sigmoid_f, Sigmoid_df};
...
ActivationFunction Tanh = {Tanh_f, Tanh_df};
...
ActivationFunction ReLU = {ReLU_f, ReLU_df};
...
ActivationFunction Leaky_ReLU = {Leaky_ReLU_f, Leaky_ReLU_df};
